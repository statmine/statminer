...
function grph_graph_line() {
  ...
  var graph = grph_generic_graph(axes, dispatch, "line", function(g, data) {
    ...
    if (d.length > 0){
      ...
      point_size = Math.min(point_size, -1 + (axes.x.width()) / (3*N));
