...
(function() {
  var DIMENSION, GEO, NUMERIC, TIME, TOPIC, add_categories, add_data_props, api, cached_meta, catalog, get_data, get_data_fields, get_datapackage, get_dims, get_tables, my_filter, odata_to_datapackage, prefilter, search, select, shallow_clone, test, to_category, to_dimension, to_label, to_table, to_tablelistitem, to_variable,
  ...
  if (test != null) {
    ...
    get_data("80576eng", my_filter, ["Goods", "Periods", "ExportValue_2"]).then(console.log);
  }
